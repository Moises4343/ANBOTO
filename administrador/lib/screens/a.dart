                    ...
                    children: [
                      ...
                      const Text(
                        ...
                        style: TextStyle(
                          color: Colors.white,
                          fontSize:
                              16, // Ajusta el tamaño del nombre según lo necesites
                          fontWeight: FontWeight
                              .bold, // Opcional, ajusta el peso de la fuente
                        ),
                      ),
                      const SizedBox(
                          height: 8), // Espacio entre el nombre y el TextField
                      ...
                      Container(
                        ...
                        child: const TextField(
                          decoration: InputDecoration(
                            border: InputBorder
                                .none, // Quita el borde del TextField
                          ),
                        ),
                      ),
                    ],
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(
                                height:
                                    8), // Espacio entre el nombre y el TextField
                      ...
                      SizedBox(
                          width: screenWidth *
                              0.05), // Espacio entre los dos elementos
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: [
                            const SizedBox(
                                height:
                                    35), // Espacio entre el nombre y el TextField
                      ...
                      Container(
                        ...
                        child: const Row(
                          children: [
                            ...
                            Icon(
                              Icons
                                  .visibility, // Cambia el ícono según lo necesites
                      ...
                      const Text(
                        ...
                        style: TextStyle(
                          ...
                          decorationColor: Color.fromARGB(
                              255, 255, 255, 255), // Color del subrayado
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color.fromARGB(
                            255, 253, 253, 253), // background (button) color
                      ),
                      child: const Text(
                        'Sign up',
